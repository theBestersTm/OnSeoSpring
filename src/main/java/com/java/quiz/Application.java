...
public class Application implements CommandLineRunner {
    ...
    public void run(String... strings) throws Exception {
        ...
        // fetch all customers
        System.out.println("found found with findAll():");
        System.out.println("-------------------------------");
        ...
        System.out.println("Quiz found with findByNameQuiz('Laptop hardware'):");
        System.out.println("--------------------------------");
        System.out.println(repository.findByNameQuiz("Laptop hardware"));

        System.out.println("Quiz found with findbyTestId('2'):");
        System.out.println("--------------------------------");
